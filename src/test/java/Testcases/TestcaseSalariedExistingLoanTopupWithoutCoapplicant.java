...
import utils.DataInputProviderSalariedExistingLoanTopupWithoutCoapplicant;

public class TestcaseSalariedExistingLoanTopupWithoutCoapplicant extends ExtentManager {
...
public static RemoteWebDriver driver;
	...
	@Test(priority=1,dataProvider="getData",dataProviderClass=DataInputProviderSalariedExistingLoanTopupWithoutCoapplicant.class)
	public static void init(String cityName,String FirstName,String LastName,String dateOfBirth,String panNumber,String livingCityName,String empType,String compName,String salary,String incentives,
			...
			String workYear,String workMonth,String loanpurposeType,String loanBank,String loanNumber,String reqTopupAmount,
	...
	.livingCity(livingCityName)
	   ...
	   .existingBankNameList(loanBank)
	   .personalDetailsContinueBtn()
	   .existingBankLoanNumber(loanNumber)
	   .personalDetailsContinueBtn()
	   	 .topupAmount(reqTopupAmount)
	   .personalDetailsContinueBtn()
	   .personalDetailsContinueBtn();
